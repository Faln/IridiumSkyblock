...
public class MoneyBankItem extends BankItem {
    ...
    public double withdraw(Player player, Number amount) {
        ...
        final double money = Math.min(amount.doubleValue(), islandBank.getNumber());
    ...
    public double deposit(Player player, Number amount) {
        ...
        final IslandBank islandBank = IridiumSkyblock.getInstance().getIslandManager().getIslandBank(island.get(), this);
        final double money = Math.min(amount.doubleValue(), IridiumSkyblock.getInstance().getEconomy().getBalance(player));
